...
module.exports = (_temp = _class = /*#__PURE__*/function (_Plugin) {
  ...
  _proto.getUploadingState = function getUploadingState(uploadProcessingStarted, uploadInitilizationComplete, isAllErrored, isAllComplete, files) {
    if (isAllErrored) {
  ...
  _proto.render = function render(state) {
    var capabilities = state.capabilities,
        ...
        error = state.error,
        uploadInitilizationComplete = state.uploadInitilizationComplete,
        uploadProcessingStarted = state.uploadProcessingStarted; // TODO: move this to Core, to share between Status Bar and Dashboard
    ...
    var supportsUploadProgress = capabilities.uploadProgress !== false && uploadInitilizationComplete;
    return StatusBarUI({
      error: error,
      ...
      uploadInitilizationComplete: uploadInitilizationComplete,
